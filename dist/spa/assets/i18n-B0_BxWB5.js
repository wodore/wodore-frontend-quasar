...
function ke(e) {
  ...
  if (S(e)) {
    ...
    if (e.constructor.name === 'Function') {
      const t = e();
      if (dn(t)) throw Y(j.NOT_SUPPORT_LOCALE_PROMISE_VALUE);
      return (Ne = t);
...
function zn(e = {}) {
  const t = S(e.onWarn) ? e.onWarn : On,
    ...
    p = S(e.localeFallbacker) ? e.localeFallbacker : Et || $n,
    $ = A(e.fallbackContext) ? e.fallbackContext : void 0,
    w = e,
...
function Oe(...e) {
  const [t, n, r] = e,
    a = {};
  if (!E(t) && !U(t) && !X(t) && !ne(t)) throw Y(j.INVALID_ARGUMENT);
...
function be(...e) {
  ...
  if (E(t)) {
    ...
    if (!c) throw Y(j.INVALID_ISO_DATE_ARGUMENT);
    const u = c[3]
...
function Ie(...e) {
  const [t, n, r, a] = e,
    s = {};
  let l = {};
  if (!U(t)) throw Y(j.INVALID_ARGUMENT);
  const _ = t;
  return (
    E(n)
      ? (s.key = n)
...
let Qe = 0;
function ze(e) {
  return (t, n, r, a) => e(n, r, lt() || void 0, a);
}
function At(e = {}, t) {
  ...
  let O = n
    ...
    p = !!e.escapeParameter;
  const $ = n ? n.modifiers : b(e.modifiers) ? e.modifiers : {};
  ...
  function Vt(...o) {
    return z(
      (i) => {
        ...
        const F = i;
        try {
          (F.processor = Wt), (R = Reflect.apply(je, null, [F, ...o]));
        } finally {
          F.processor = null;
        }
        return R;
...
const Pr = { failed: 'Action failed', success: 'Action was successful' },
  Dr = { 'en-US': Pr },
  yr = _n(({ app: e }) => {
    const t = Nr({ locale: 'en-US', legacy: !1, messages: Dr });
    e.use(t);
  });

...
import { l as getCurrentInstance, s as ref, aw as isKeyCode, bc as prevent, A as nextTick, ba as addEvt, x as watch, z as onMounted, B as onBeforeUnmount, be as cleanEvt, bf as listenOpts, bq as portalProxyList, b7 as client, aV as getScrollbarWidth, bk as defineStore, t as computed, br as Notify } from "./index-CAHSu7Ql.js";
...
const useHutsStore = defineStore("huts", () => {
  const emptyHutBookingsGeojson = {
  ...
  async function fetchHutBookingsGeojson({
    ...
    clientWodore.GET("/v1/huts/bookings.geojson", {
      params: {
        query: {
          date,
          days
  ...
  const selectedMonth = computed(() => {
    ...
    return ((/* @__PURE__ */ new Date()).getMonth() + 1).toString().padStart(2, "0");
  });
  return {
    //hutsGeojson,
    bookingsGeojson,
...
export {
  ...
  useHutsStore as b,
  validateOffset as c,
  useScrollTarget as d,
  addClickOutside as e,
  useAnchorStaticProps as f,
  parsePosition as p,
  removeClickOutside as r,
  setPosition as s,
  useAnchorProps as u,
  validatePosition as v
};

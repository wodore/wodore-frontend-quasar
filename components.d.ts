...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    IconEvaLock: (typeof import('~icons/eva/lock'))['default']
    IconEvaLockFill: typeof import('~icons/eva/lock-fill')['default']
    IconEvaLockOutline: (typeof import('~icons/eva/lock-outline'))['default']
    IconEvaMoveOutline: typeof import('~icons/eva/move-outline')['default']
    IconEvaSearch: (typeof import('~icons/eva/search'))['default']
    ...
    WdHutSearch: (typeof import('./src/components/WdHutSearch.vue'))['default']
    WdHutSearchInput: (typeof import('./src/components/WdHutSearchInput.vue'))['default']
    WdHutSearchMobile: (typeof import('./src/components/WdHutSearchMobile.vue'))['default']
